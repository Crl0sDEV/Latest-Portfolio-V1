    ...
    <main className="relative w-full min-h-screen bg-black text-white px-6 flex flex-col items-center justify-center overflow-hidden py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="absolute inset-0 bg-green-400 blur-[80px] opacity-20 rounded-full w-[70%] h-[70%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
          
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[450px] lg:h-[450px] rounded-full p-1.5 bg-green-500 shadow-2xl shadow-green-500/20">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-2">
            ...
            <Reveal>
              <h1 className="text-4xl md:text-6xl font-bold bg-green-400 bg-clip-text text-transparent animate-pulse drop-shadow-[0_0_10px_rgba(74,222,128,0.6)] py-2 leading-tight">
                Hi, I&apos;m <br />
            ...
            <Reveal delay={0.5}>
              <div className="mt-8 flex flex-wrap justify-center lg:justify-start gap-5">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-full bg-green-500 text-black font-bold shadow-lg overflow-hidden transition-all hover:bg-green-400"
                >
                ...
                <Link href="/contact">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="inline-flex items-center gap-3 px-8 py-4 rounded-full border-2 border-green-500 text-green-400 font-bold hover:bg-green-500/10 hover:text-green-300 transition-all"
                  >
            ...
            <div className="mt-12 lg:self-start flex items-center gap-4">
