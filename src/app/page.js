...
// --- SPOTLIGHT CARD HELPER (Para sa Description Box) ---
    ...
    <main className="relative w-full min-h-screen bg-black text-white px-6 flex flex-col items-center justify-center overflow-hidden py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.div
             animate={{ y: [0, -20, 0] }} // Smooth Float Up & Down
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-2">
            ...
            <Reveal delay={0.5}>
              <div className="mt-8 flex flex-wrap justify-center lg:justify-start gap-5">
                ...
                {/* BUTTON 2: CONTACT (Glassmorphism) */}
                <Link href="/contact">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
            ...
            {/* STATS ROW */}
            <Reveal delay={0.6}>
                <div className="mt-12 lg:self-start flex items-center gap-6 p-2 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-sm">
                    <LikeButton />
                    <div className="w-px h-8 bg-white/10"></div> {/* Vertical Divider */}
                    <VisitorCounter />
                </div>
            </Reveal>
