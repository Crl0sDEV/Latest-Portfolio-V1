    ...
    <Reveal delay={0.3}>
      <div className="h-full bg-zinc-900/50 backdrop-blur-md border border-white/10 p-8 rounded-2xl flex flex-col justify-center items-center text-center shadow-xl relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col items-center w-full">
            <div className="w-20 h-20 bg-blue-500/20 rounded-full flex items-center justify-center text-blue-400 text-4xl mb-6 group-hover:scale-110 transition-transform duration-300">
            <FaEnvelope />
            </div>
